#!/bin/bash
# =================================================================
# REBUILD_WPBYNGINX.SH (FULL AUTO-INSTALL + SUMMARY)
# =================================================================
...
# --- 2. INSTALLATION ---
echo "[2/6] Memasang paket LEMP (PHP 8.3), Fail2Ban & Email Tool..."
apt update && apt install nginx mariadb-server php8.3-fpm php8.3-mysql php8.3-gd php8.3-curl php8.3-mbstring php8.3-xml php8.3-zip fail2ban msmtp msmtp-mta -y

# --- 3. DATABASE CONFIG ---
echo "[3/6] Mengonfigurasi MariaDB..."
